      ...
      <div className="register-big-wrapper">
        ...
        <div className="section-wrapper">
          ...
          <div className="top-register-explain">
            ...
            <p>
              BlogPulse is a platform where you can share your thoughts and ideas with the world related to the current technology trends.
          ...
          <form onSubmit={registerHandler} >
            ...
            <p  className="mt-2 " >
               &larr; <a style={{textDecoration: "none", color: "black" , fontWeight: "bold"}} href="/">Back to home </a>
            </p>
